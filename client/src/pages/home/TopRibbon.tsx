...
export const TopRibbon = () => {
  ...
  return (
    <div>
      <div className="bg-gray-700 p-2  flex items-center gap-4">
      ...
      <div className="text-center pt-3 pb-2 overflow-hidden text-4xl bg-gradient-to-b from-gray-700 to-transparent">
